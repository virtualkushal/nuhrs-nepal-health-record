"""
Django settings for the Nepal Mediciti Hospital service.

This is a STANDALONE hospital edge system in the NUHRS federation. It owns its
own database (schema shaped exactly like Mediciti's real HMIS) and exposes a
...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-insecure-mediciti-key")
